      ...
      <div className="ml-auto flex min-w-0 items-center gap-2 sm:flex-1 sm:justify-end">
        {showSearch && (
          <label className="relative mr-auto hidden sm:block sm:w-full sm:max-w-lg">
            ...
            />
            <kbd className="ui-muted pointer-events-none absolute right-2.5 top-1/2 hidden -translate-y-1/2 rounded border ui-border px-1.5 py-0.5 text-[10px] font-semibold lg:block">
              Ctrl K
            </kbd>
          </label>
        )}
